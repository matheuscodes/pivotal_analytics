...
public class Ticket {
	 ...
	 * @see software.matheus.pivotal_analytics.pivotal.TicketSet#queryUniqueTypes()
	 * @return the type.
	 */
	 ...
	 * @see software.matheus.pivotal_analytics.pivotal.TicketSet#queryUniqueStates()
	 * @return the state.
	 */
	...
	public void addMissingIterationLabel(int i) {
		if(this.StoryType.compareTo("feature") == 0){
			...
			else if(!this.labels.contains("["+i+"]")){
				this.labels += ",["+i+"]";
			}
		}
	}
